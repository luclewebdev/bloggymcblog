 ...
 */
final class Version20231023102045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT NOT NULL, author_id INT DEFAULT NULL, article_id INT DEFAULT NULL, content TEXT NOT NULL, PRIMARY KEY(id))');
